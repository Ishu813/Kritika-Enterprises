      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-base text-gray-400 max-w-3xl mx-auto">
            Get personalized help from our tech experts. Whether you need
            product recommendations, technical support, or custom solutions,
            we're here to help.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full bg-[#2563eb] hover:bg-[#1e40af] text-white py-3 flex items-center justify-center space-x-2"
              >
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-900 to-purple-900 rounded-lg p-8 border border-blue-500">
              <h3 className="text-xl font-bold text-white mb-4">
                Why Choose Our Expert Assistance?
              </h3>
