        ...
        <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-50 max-w-2xl mx-auto">
              Our platform combines cutting-edge technology with expert human
          ...
          <div className="text-center mb-6">
            <div className="font-bold text-white text-3xl sm:text-4xl md:text-5xl">
              ...
              <div className="text-base text-slate-400 max-w-2xl mx-auto leading-relaxed text-center mt-2">
                Your premier destination for cutting-edge gaming and tech
                solutions. We specialize in high-performance hardware, gaming
                accessories, and innovative technology that powers your digital
                lifestyle.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-4 pt-8 sm:gap-8 items-start">
            <div className="text-left w-full lg:w-1/2">
              ...
              <p className="text text-lg sm:text-xl mt-2 sm:mt-4 w-full sm:w-4/5 mx-auto lg:mx-0">
                At Kritika Enterprises, we specialize in providing
                high-performance hardware solutions for both businesses and
                individual consumers. We deliver only the best from leading
                global brands like HP, Dell, and ASUS. Whether you're a
                hospital, a startup, or a home user, we ensure fast, reliable
                tech solutions with unmatched support.
              </p>
            </div>
                ...
                {carouselImages.map((_, idx) => (
                  <span
                    ...
                    className={`w-2 h-2 rounded-full ${
                      idx === current ? "bg-[#7C3AED]" : "bg-gray-300"
                    }`}
                  />
                ))}
              </div>
