    ...
    <div className="min-h-screen bg-[#0f172a] text-white px-6 py-12 sm:px-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 justify-center">
        {teamMembers.map((dev, index) => (
          <div
            key={index}
            className="bg-[#1e293b] w-full max-w-[250px] mx-auto rounded-xl p-5 border border-transparent hover:border-[3px] hover:border-[#3878d8] hover:shadow-[0_0_15px_#3878d8] hover:scale-105 transition-all duration-300"
          >
            <img
              src={dev.img}
              alt={dev.name}
